...
def plume_model_demo(dt=0.01, t_max=100, steps_per_frame=200,seed=DEFAULT_SEED):
...
#plume_model_demo(dt=0.01, t_max=100, steps_per_frame=200,seed=DEFAULT_SEED)
#wind_model_demo(dt=0.01, t_max=100, steps_per_frame=20, seed=DEFAULT_SEED)  
# conc_point_val_demo(dt=0.01, t_max=5, steps_per_frame=1, x=10., y=0.0,seed=DEFAULT_SEED)
concentration_array_demo(dt=0.01, t_max=100, steps_per_frame=50,seed=DEFAULT_SEED)
